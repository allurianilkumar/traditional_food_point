<?php
        ...
        if($conn) {
            if(isset($_POST['submit_order']))
            {
                ...
                $result = "INSERT INTO `CustomerOrder`(`FirstName`, `LastName`, `Gender`, `Phone`, `ItemName`, `OrderLocation`, `OrderDate`, `OrderTime`, `Cost`, `Quantity`, `Message`, `CreatedDate`) VALUES 
                ('$FirstName','$LastName', '$Gender', '$Phone', '$ItemName', '$OrderLocation', '$OrderDate', '$OrderTime', '$Cost', '$Quantity', '$Message', sysdate())";
    ...
    <div class="col-sm-8" id="grid">
       <div class="panel panel-default">
            <div class="panel-heading">
                <center><h4><span class="glyphicon">Cool Drinks</span></h4></center>
            </div>
            <div class="panel-body">
                <ul class="text-center">
                            <?php
                            $mysqli = new mysqli('localhost','root','password','traditional_food_point');
                             $sql = "SELECT `Id`, `Names` FROM `CoolDrinks`";
                            ...
                            <table border="2px">
                                   <?php while ($fetch = $res->fetch_assoc()) { ?>
                                    <tr>
                                        <a name="link" href="../cool_drinks/products.php?name=<?php echo $fetch['Names']?>"><?php echo $fetch['Names']?><br></a></td>
                                    </tr><?php } ?>
                            </table>
                            <?php 
                            }   else
