...
<div id="home_li">
    <ul class="list-unstyled">
        <li><b><a href="/traditional_food_point/">Home</a>&nbsp;<span>&gt;&gt;</span>&nbsp;<a href="/traditional_food_point/cool_drinks/index.php">Cool Drinks</a>&nbsp;<span>&gt;&gt;</span>&nbsp; <?php echo $name;?></b></li>
    </ul>
</div>
    <div class="container">
        <?php
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="bs-example">
                                                        <form class="form-horizontal" action="/traditional_food_point/vegetarian/index.php" method="post">
