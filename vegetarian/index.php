    ...
    <div class="col-sm-8" id="grid">
       <div class="panel panel-default">
            <div class="panel-heading">
                <center><h4><span class="glyphicon">Vegetarian</span></h4></center>
            </div>
                ...
                <ul class="text-center">
                            ...
                            <table border="2px">
                                   <?php while ($fetch = $res->fetch_assoc()) { ?>
                                    <tr>
                                        <a name="link" href="../vegetarian/products.php?name=<?php echo $fetch['Names']?>"><?php echo $fetch['Names']?><br></a></td>
                                    </tr><?php } ?>
                            </table>
                            <?php 
                            }   else
